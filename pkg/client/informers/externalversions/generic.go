...
import (
	...
	v1alpha1 "github.com/clay-wangzhi/koordinator/apis/slo/v1alpha1"
...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("nodemetrics"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Slo().V1alpha1().NodeMetrics().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("nodeslos"):

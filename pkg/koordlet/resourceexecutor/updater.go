...
func NewCgroupUpdaterWithUpdateFunc(updateFn UpdateFunc) func(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
	return func(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
		return NewCgroupUpdater(resourceType, parentDir, value, updateFn)
	}
}
...
func NewCommonCgroupUpdater(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
	return NewCgroupUpdaterWithUpdateFunc(CommonCgroupUpdateFunc)(resourceType, parentDir, value)
}

func NewMergeableCgroupUpdaterWithCondition(resourceType sysutil.ResourceType, parentDir string, value string, updateFunc UpdateFunc, mergeCondition MergeConditionFunc) (ResourceUpdater, error) {
	r, err := sysutil.GetCgroupResource(resourceType)
	if err != nil {
		return nil, err
	}
...
func NewMergeableCgroupUpdaterWithConditionFunc(updateFn UpdateFunc, mergeCondition MergeConditionFunc) func(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
	return func(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
		return NewMergeableCgroupUpdaterWithCondition(resourceType, parentDir, value, updateFn, mergeCondition)
	}
}
...
func NewMergeableCgroupUpdaterIfValueLarger(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
	return NewMergeableCgroupUpdaterWithConditionFunc(CommonCgroupUpdateFunc, MergeConditionIfValueIsLarger)(resourceType, parentDir, value)
}
...
func cgroupWriteIfDifferentWithLog(c *CgroupResourceUpdater) error {
	_, err := cgroupFileWriteIfDifferent(c.parentDir, c.file, c.value)
	if err != nil {
		return err
	}
...
func commonWriteIfDifferentWithLog(c *DefaultResourceUpdater) error {
	_, err := sysutil.CommonFileWriteIfDifferent(c.Path(), c.value)
	if err != nil {
		return err
	}
	return nil
...
func NewBlkIOResourceUpdater(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
	return NewCgroupUpdaterWithUpdateFunc(BlkIOUpdateFunc)(resourceType, parentDir, value)
}

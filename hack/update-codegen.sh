...
ROOT_PKG=github.com/clay-wangzhi/koordinator
...
${SCRIPT_ROOT}/hack/generate-internal-groups.sh \
  ...
  github.com/clay-wangzhi/koordinator/pkg/scheduler/apis/generated \
  github.com/clay-wangzhi/koordinator/pkg/scheduler/apis \
  github.com/clay-wangzhi/koordinator/pkg/scheduler/apis \
  "config:v1beta3" \
  --output-base "${TEMP_DIR}" \
  --go-header-file hack/boilerplate/boilerplate.go.txt
...
${SCRIPT_ROOT}/hack/generate-internal-groups.sh \
  "deepcopy,conversion,defaulter" \
  github.com/clay-wangzhi/koordinator/pkg/descheduler/apis/generated \
  github.com/clay-wangzhi/koordinator/pkg/descheduler/apis \
  github.com/clay-wangzhi/koordinator/pkg/descheduler/apis \
  "config:v1alpha2" \
  --output-base "${TEMP_DIR}" \
  --go-header-file hack/boilerplate/boilerplate.go.txt
